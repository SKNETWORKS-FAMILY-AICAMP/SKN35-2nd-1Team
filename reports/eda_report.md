...
장학금·채무 여부도 동일한 방향으로 뚜렷한 차이를 보인다. 성별 간에도 20%p 차이(남성 45.1% vs 여성 25.1%)가 있다 (Gender 코드는 UCI 공식 변수표 기준 1=남성, 0=여성으로 확인됨 — [UCI Variables Table](https://archive.ics.uci.edu/dataset/697/predict+students+dropout+and+academic+success)).
